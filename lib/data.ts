...
export const projects: Project[] = [
  {
    ...
    githubUrl: "https://github.com/SUMIT-KUMAR-SHAKYA/Labour-Connect-2.0",
    badge: "Live",
    badgeColor: "teal",
    featured: true,
    color: "#2dd4bf",
  },
  {
    ...
    githubUrl: "https://github.com/SUMIT-KUMAR-SHAKYA/labor-connect",
    badge: "Live",
    badgeColor: "cyan",
    featured: true,
    color: "#0ea5e9",
  },
  {
    ...
    githubUrl: "https://github.com/SUMIT-KUMAR-SHAKYA/Movie-Sentiment-Analyzer",
    badge: "AI/ML",
    badgeColor: "purple",
    featured: true,
    color: "#a78bfa",
  },
  {
    ...
    githubUrl: "https://github.com/SUMIT-KUMAR-SHAKYA/Smart-Food-Delivery",
    badge: "Open Source",
    badgeColor: "teal",
    featured: true,
    color: "#f43f5e",
